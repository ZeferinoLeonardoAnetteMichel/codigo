...
-- Eventos
--
CREATE DEFINER=`root`@`localhost` EVENT `evento_generar_qr` ON SCHEDULE EVERY 3 MINUTE STARTS '2026-05-19 16:25:56' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
